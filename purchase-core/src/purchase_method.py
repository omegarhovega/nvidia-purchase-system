...
if __name__ == "__main__":
    # Get the purchase URL from command-line argument
    if len(sys.argv) > 1:
        purchase_url = sys.argv[1]
        print(f"[INFO] Using purchase URL from command-line argument: {purchase_url}")
    else:
        # Default test URL (same as in original code)
        purchase_url = "https://www.proshop.de/Basket/BuyNvidiaGraphicCard?t=C8HgkfqkAbdVIyPnb%2B%2BHQOoYO6UhnuDDA8853HMVzu6Wh3v2YAtSuPC5hOcGnQqGZve77PQt9%2FdBgsLw327GJu35bgsktZFF01sZq2Ggu5VIedzHT6GMr%2BVdEl%2BqK6TJO6kIOoOFHkGPYbDnU8scv53inA8cgPvwQ4n8soRyD7EDfEYavWDPah8%2B%2BIPQye8LL8ymAba361B0pjcQgb1L2a4ap8SgOYum1voEi19FqaiPbcOn%2F1tmFZfTqw38ZrsV0wrokDAOcjaGLeiD5ujyc%2F9uY7GAJRGtEasilCzFJhECHYSimA9q8Pd9vJh%2FVhd9j%2BW3WlTmmTM4Pt3vimM2KQ%3D%3D"
        print(f"[INFO] Using default purchase URL: {purchase_url}")

    # Run the purchase function
    if fast_purchase(purchase_url):
